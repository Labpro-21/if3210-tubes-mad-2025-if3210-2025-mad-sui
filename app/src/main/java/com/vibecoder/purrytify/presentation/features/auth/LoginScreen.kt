...
import com.vibecoder.purrytify.presentation.components.TextInputComponent // <-- IMPORT the new
// component
...
fun LoginScreen(onLoginSuccess: () -> Unit, viewModel: LoginViewModel = hiltViewModel()) {
    ...
    Surface(modifier = Modifier.fillMaxSize(), color = MaterialTheme.colorScheme.background) {
        Box(modifier = Modifier.fillMaxSize()) {
            Box(modifier = Modifier.fillMaxWidth().align(Alignment.TopCenter).offset(y = 75.dp)) {
                Image(
